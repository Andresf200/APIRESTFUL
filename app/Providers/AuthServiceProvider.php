...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Passport::tokensCan([
            'purchase-product' =>  'Crear transacciones para compras de productos determinados',
            ...
            'read-general' => 'Obtener información general, categorias donde se compra
                y se vende, productos vendidos o comprados, transacciones, compras y ventas',
        ]);
    }
}
